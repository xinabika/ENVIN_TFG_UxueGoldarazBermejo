...
namespace SICCA_IC.Model
{
    ...
    public partial class F_wsENVIN_Web_Infecciones_Microorganismos_IDInfeccion_Result
    {
        ...
        public Nullable<int> wsENVIN_Web_Maestro_Microorganismos_GrupoMicroorganismos_ID { get; set; }
